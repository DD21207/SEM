...
export default{
	...
	data(){
		return{
            ...
            options1_selected:"Impression",
            options2_selected:"Click",
            startDate:"",
            endDate:"",
            dataList:{
                titleX:"Impression",
                titleY:"Click",
                pointValueX_mean:170,
                pointValueY_mean:70,
                pointValueX_median:150,
                pointValueY_median:80,
                optionData:[
                [161.2, 51.6],
                [167.5, 59.0],
                [159.5, 49.2],
	...
	methods:{
        ...
        onChangeChart(){
            ...
            this.startDate = $("#timeCustom").val().split(" ~ ")[0].split("-");
            this.endDate= $("#timeCustom").val().split(" ~ ")[1].split("-");
        },

        selectDisabled(){
            var _this = this;
            $.each(this.options1,function(index,select) {
                if(select.value == _this.options2_selected){
            ...
            this.dataList.titleX=this.options1_selected;
            this.dataList.titleY=this.options2_selected;
        ...
        selectDisabled1(){
            ...
            $.each(this.options2,function(index,select) {
                if(select.value == _this.options1_selected){
    ...
    watch:{
        'options1_selected': 'selectDisabled1',
