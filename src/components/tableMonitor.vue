  ...
  methods: {
      ...
      getSummaries(param) {
        ...
        columns.forEach((column, index) => {
          ...
          if(index === 7){
              sums[index] = Math.round(sums[5]*100 / sums[4]*100)/100 + '%'
          }else if(index === 8){
              sums[index] = Math.floor((sums[6] / sums[5]) * 100) / 100
          }else if(index === 9){
            sums[index] = "1.56"
          }else if( index === 10 || index === 11 || index === 12 ||index === 13 ||index === 14 ||index === 15){
            sums[index] = '--';
            return;
          }
        });
